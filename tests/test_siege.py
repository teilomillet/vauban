...
import vauban
from vauban.interfaces import Target, AttackPrompt
...
async def test_siege_wiring(mock_create_intel, mock_judge_cls, mock_engine_cls, mock_gepa_cls):
    """
    ...
    mock_engine.run = AsyncMock(return_value=SiegeResult(
        success=False, 
        max_score=1.0, 
        history=[], 
        stats={}
