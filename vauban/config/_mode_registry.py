...
EARLY_MODE_SPECS: tuple[EarlyModeSpec, ...] = (
    ...
    EarlyModeSpec(
        ...
        "standalone",
        False,
        _field_is_set("benchmark"),
        "Generate a comparative model safety/evidence scorecard.",
        "benchmark scorecard",
        "[benchmark] section present.",
        "benchmark_scorecard.json + benchmark_scorecard.md.",
    ),
    EarlyModeSpec(
        "[behavior_report]",
        "behavior_report",
        ...
        "Generate a typed Model Behavior Change Report from TOML evidence.",
    ...
    EarlyModeSpec(
        ...
        "standalone",
        False,
        _field_is_set("token_audit"),
        "Inventory risky token classes and tokenizer control-plane surfaces.",
        "tokenizer control-plane audit",
        "[token_audit] section present.",
