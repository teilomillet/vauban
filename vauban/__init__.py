...
_LAZY_IMPORTS: dict[str, str | tuple[str, str]] = {
    ...
    "BenchmarkArtifacts": "vauban.scorecard",
    "BenchmarkConfig": "vauban.types",
    "BenchmarkModelConfig": "vauban.types",
    "BenchmarkWeightsConfig": "vauban.types",
    ...
    "TokenAuditConfig": "vauban.types",
    "TokenAuditResult": "vauban.types",
    ...
    "build_benchmark_artifacts": "vauban.scorecard",
    ...
    "run_token_audit": "vauban.token_audit",
