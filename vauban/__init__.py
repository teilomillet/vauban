...
_LAZY_IMPORTS: dict[str, str | tuple[str, str]] = {
    ...
    "ApiEvalConfig": "vauban.types",
    "ApiEvalEndpoint": "vauban.types",
    "ApiTraceResponse": "vauban.api_trace",
    ...
    "BehaviorTraceApiConfig": "vauban.types",
    ...
    "CapabilityQuestion": "vauban.capabilities",
    "CapabilitySpec": "vauban.capabilities",
    "CapabilitySurface": "vauban.capabilities",
    ...
    "access_policy_for_capabilities": "vauban.runtime",
    "access_policy_for_level": "vauban.behavior",
    "access_policy_for_trace": "vauban.runtime",
    ...
    "capabilities_by_question": "vauban.capabilities",
    "capability_by_name": "vauban.capabilities",
    "capability_catalog": "vauban.capabilities",
    "capability_names": "vauban.capabilities",
    "capture_intent": "vauban.intent",
    "call_api_behavior_trace": "vauban.api_trace",
